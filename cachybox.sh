...
if distrobox list | grep -q " ${CONTAINER_NAME} "; then
    ...
    distrobox create --name "${CONTAINER_NAME}" --image "${CONTAINER_IMAGE}" --init --nvidia --hostname "${HOSTNAME}"

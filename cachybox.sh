...
yay -Syu --noconfirm npm zsh bash spyder github-cli typescript eslint helm python-pip gdb gcc make maven jdk-openjdk kotlin clang llvm lld lldb libc++ cython libclc polly rustup antigravity gemini-cli google-chrome cachyos-gaming-applications cachyos-gaming-meta lsfg-vk-bin
rustup update
